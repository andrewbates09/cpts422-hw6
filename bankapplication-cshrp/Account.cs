...
public class Account
{
		...
		public Account(double initialBalance, int newAccountNumber, string newName) : this(initialBalance, newAccountNumber, newName, "")
		{
		}
		public Account(double initialBalance, int newAccountNumber) : this(initialBalance, newAccountNumber, "", "")
		{
		}
		public Account(double initialBalance) : this(initialBalance, 0, "", "")
		{
		}
...
//ORIGINAL LINE: Account(double initialBalance = 0.0, int newAccountNumber = 0, string newName = "", string newDateCreated = "")
		public Account(double initialBalance, int newAccountNumber, string newName, string newDateCreated)
		{
